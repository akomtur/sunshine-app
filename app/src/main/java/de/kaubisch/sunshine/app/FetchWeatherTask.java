...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor query = resolver.query(LocationEntry.CONTENT_URI
        ...
        if (query.moveToFirst()) {
            locationId = query.getInt(query.getColumnIndex(LocationEntry._ID));
        } else {
            ...
            Uri insert = resolver.insert(LocationEntry.CONTENT_URI, contentValues);
            if (insert != null) {
